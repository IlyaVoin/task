async function getCurrentWeatherByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/current.json?key=a90e8a99d1c34c13a15181933253004&q=${city}&aqi=no`)
...
async function getForecastByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=a90e8a99d1c34c13a15181933253004&q=${city}&days=1&aqi=no&alerts=no`)
